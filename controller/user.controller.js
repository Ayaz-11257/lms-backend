...
//     if (!user) {
//         return next(new AppError('User registration failed, please try again later', 500))
//     }
...
//     const message = `you can change your password by clicking this ${resetPasswordURL}`;
...
//         await user.save();
//          return next(new AppError(e.messsage, 400));
//     }
// }
...
//     if(!isPasswordValid) {
//         return next(
//             new AppError('invalid old apssword', 400)
//         )
//     }
...
//     user.password = undefined //yeh hamesha likhte hai taaki galti se bhi password na leak hojaye
